...
#RReservation.create(startdate:Time.now, enddate:Time.now, guest:"y.dorantes@itesm.mx, rafagarciafdz@itesm.mx", status:0, userapproved:"laura@itesm.mx", user:User.first, reservable:Place.first)
